...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-study-buddy-dev-key-change-in-production')
...
WEBHOOK_VERIFY_TOKEN = os.environ.get('WEBHOOK_VERIFY_TOKEN', 'studybuddy_verify_2024')
